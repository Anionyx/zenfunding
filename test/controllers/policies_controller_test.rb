...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test "should create policy" do
    assert_difference('Policy.count') do
      post :create, policy: { dead_person_id: @policy.dead_person_id, face_value: @policy.face_value, number_policy: @policy.number_policy }
    end
  ...
  test "should update policy" do
    patch :update, id: @policy, policy: { dead_person_id: @policy.dead_person_id, face_value: @policy.face_value, number_policy: @policy.number_policy }
    assert_redirected_to policy_path(assigns(:policy))
  end
